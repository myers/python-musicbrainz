...
if os.name == "nt":
    ...
    mbdll = cdll.LoadLibrary("libmusicbrainz.so.4")
...
class mb:
    ...
    #mbdll.mb_GetQueryError.argtypes = [c_void_p, c_void_p, c_int]
    ...
    def GetOrdinalFromList(self, resultList, url):
        return mbdll.mb_mb_GetOrdinalFromList(self.mb, resultList, url)
